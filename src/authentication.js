...
@inject(Api, ApplicationState, AppConfig)
export class Authentication {

  constructor(Api, ApplicationState, AppConfig) {
    this.api = Api;
    ...
    this.authEnabled()
    .then(data => {
      this.APPSTATE.authEnabled = data;
    })
    .catch(reason => {
      logger.error('AuthEnabled: ', this.APPSTATE.authEnabled)
    });
    logger.debug('AuthEnabled: ', this.APPSTATE.authEnabled);
  }
